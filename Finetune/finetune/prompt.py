...
# Keep in sync with src/translator/prompt.py. The fine-tune was supervised
# almost entirely on questions framed exactly this way (a single declarative
# claim after the colon), so inference must re-frame options the same way.
